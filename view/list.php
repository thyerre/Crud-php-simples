<div>
           ...
           foreach($user->getUsuarios() as $user){
			   ...
			   ?>
                ...
                <a href='?acao=delete&id=<?=$user->id?>'<button type='submit' style='margin-left:0%'  name='bntExcluir' class='btn btn-danger'>Excluir</button></a><a href='?acao=disable&id=<?=$user->id?>'<button type='submit' style='margin-left:1%'  name='bntDisable' class='btn btn-outline-secondary'>Desabilitar</button></a>
